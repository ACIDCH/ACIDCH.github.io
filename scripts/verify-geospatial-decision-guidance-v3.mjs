...
const files = {
  ...
  transshipment: await readFile("src/scripts/geospatial-transshipment.js", "utf8"),
...
requireToken(files.fleet, "state.routeCache.clear()", "Fleet route-cache invalidation before each rebuild");
requireToken(
  files.transshipment,
  "state.routeCache.clear()",
  "transshipment route-cache invalidation before each rerun",
);
