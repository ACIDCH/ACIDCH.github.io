...
export interface SharedUiCopy {
  ...
  home: {
    ...
    themes: string;
    cta: string;
    interactiveProject: string;
    geospatialProject: string;
    geospatialProjectDescription: string;
  };
  noteList: {
    empty: string;
    draft: string;
    ...
    search: {
      ...
      pages: [
        ...
        },
        {
          ...
          path: "/notes/",
          searchText: "Notes Learning Notes analytics optimisation tools",
        },
        {
          title: "About",
